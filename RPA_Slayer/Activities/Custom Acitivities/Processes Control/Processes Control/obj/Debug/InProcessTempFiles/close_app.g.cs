...
namespace Processes_Control {
    ...
    public partial class close_app : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(close_app).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(close_app));
        ...
        private string FindResource() {
            string[] resources = typeof(close_app).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".close_app.g.xaml") || resource.Equals("close_app.g.xaml"))) {
                    return resource;
                }
            }
